<?php namespace App\Http\Controllers;
	...
	class AdminSatkerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Nama Singkat","name"=>"nama_singkat"];
			...
			$this->form[] = ['label'=>'Nama Singkat','name'=>'nama_singkat','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
