<?php namespace App\Http\Controllers;
	...
	class AdminNominatifController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Kegiatan Id","name"=>"kegiatan_id","join"=>"kegiatan,id"];
			$this->col[] = ["label"=>"Peserta Id","name"=>"peserta_id","join"=>"peserta,id"];
			...
			$this->col[] = ["label"=>"Daerah Asal","name"=>"daerah_asal"];
			...
			$this->form[] = ['label'=>'Transport','name'=>'transport','type'=>'money','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Peserta Id","name"=>"peserta_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"peserta,id"];
			//$this->form[] = ["label"=>"Nama Peserta","name"=>"nama_peserta","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Daerah Asal","name"=>"daerah_asal","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Prov Daerah Tujuan","name"=>"prov_daerah_tujuan","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Kab Daerah Tujuan","name"=>"kab_daerah_tujuan","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Tgl Berangkat","name"=>"tgl_berangkat","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
			...
			//$this->form[] = ["label"=>"Tiket Pesawat","name"=>"tiket_pesawat","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Transport","name"=>"transport","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Uang Harian","name"=>"uang_harian","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Penginapan","name"=>"penginapan","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Taksi Kabupaten","name"=>"taksi_kabupaten","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Taksi Provinsi","name"=>"taksi_provinsi","type"=>"money","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"Jenis Peserta","name"=>"jenis_peserta","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
	    ...
	    */
		...
		{
			$page_title = "List Nominatif";
    		$this->cbView('backend.pengajuan.kegiatan.nominatif.index',compact('page_title'));
