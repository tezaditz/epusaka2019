<?php namespace App\Http\Controllers;
	...
	class AdminBagianUserController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "bagian_user";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Bagian","name"=>"bagian_id","join"=>"bagian,nama"];
			$this->col[] = ["label"=>"Nama User ","name"=>"user_id","join"=>"cms_users,name"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Bagian Id','name'=>'bagian_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'bagian,nama' , 'datatable_where' => 'satker_id=' . $satkeruser->satker_id . ''];
			if(CRUDBooster::myPrivilegeName() != 'Super Administrator')
				{
					$this->form[] = ['label'=>'User Id','name'=>'user_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'cms_users,name' , 'datatable_where'=> 'id_cms_privileges != 1' ];
				}
				else
				{
