<?php namespace App\Http\Controllers;
	...
	class AdminDakunController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "detail_akun";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Akun","name"=>"akun"];
			...
			$this->form[] = ['label'=>'Akun','name'=>'akun','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Akun","name"=>"akun","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
