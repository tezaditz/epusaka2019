<?php namespace App\Http\Controllers;
	...
	class AdminRkaklRevisiUploadController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "rkakl_revisi_upload";
			...
			$this->form[] = ['label'=>'Thnang','name'=>'thnang','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
